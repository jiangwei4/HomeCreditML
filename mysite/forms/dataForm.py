...
class DataForm(forms.Form):
    ...
    DAYS_BIRTH = forms.DateField(label="Date de naissance", input_formats=['%m/%d/%Y'])
    REGION_RATING_CLIENT_W_CITY = forms.IntegerField()
    ...
    WEEKDAY_APPR_PROCESS_START = forms.ChoiceField(label="Jour de lancement du processus", choices=WEEKDAY_APPR_PROCESS_START_CHOICES)    
